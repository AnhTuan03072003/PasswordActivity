...
date=gg.makeRequest("http://www.whatismyip.org").headers["Date" ][1] 
...
pass("hmghakk_17052024_CmIT0wttEt","t")
...
if VIPONLY[2]== true then MAGIC1() end
...
local function name(lib)
	...
	local ranges = gg.getRangesList(lib or 'libanogs.so')
...
local function setHexMemory(libname, offset, hex)
	...
	if type(res) ~= 'string' then
		...
		return false
            ...
            setHexMemory("libanogs.so", 0xDF2FC, "00 00 80 D2 C0 03 5F D6")
